  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Ready to scan equipment installations</p>
      </div>
        ...
        <Card className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-emerald-100 text-sm font-medium">Active Sessions</p>
                <p className="text-3xl font-bold mt-1">{activeSessions}</p>
              </div>
              <div className="bg-emerald-400 bg-opacity-50 p-3 rounded-full">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1 text-gray-900">{completedSessions}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1 text-gray-900">{totalScans}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1 text-gray-900">{sessions.length}</p>
              </div>
      ...
      <div className="mb-8">
        <Card className="bg-gradient-to-r from-gray-50 to-gray-100 border-2 border-dashed border-gray-300">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Start New Installation</h3>
            <p className="text-gray-600 mb-6">Select a site and begin scanning equipment</p>
            <Link to={createPageUrl("SiteSelection")}>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {sessions.map((session) => (
                <div
                  key={session.id}
                  className={`p-4 rounded-lg border-l-4 ${getBrandColor(
                    session.site_code
