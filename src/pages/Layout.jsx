...
import { MonitorSpeaker, Home, Settings, Shield } from "lucide-react"; // Import Shield icon
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                {localStorage.getItem('adminAuthExpiry') && new Date(localStorage.getItem('adminAuthExpiry')) > new Date() && (
                  <Link
