...
import QuickReferenceSheet from "../components/common/QuickReferenceSheet";
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="animate-pulse space-y-6">
          ...
          <ListItemSkeleton count={1} height="h-48" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <EmptyState
          ...
          message="Could not load the session data. It may have been deleted or there was a problem loading it."
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <ConfirmationDialog
        ...
        description="This will mark the session as complete and take you to the export page. You won't be able to scan more items."
